...
public sealed class VariableHeightPageInitializationTests
{
    [AvaloniaFact]
    public void VariableHeightPage_GeneratesItems_WhenAttached()
    {
        ...
        var viewModel = Assert.IsType<VariableHeightViewModel>(page.DataContext);
