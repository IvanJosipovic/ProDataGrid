...
public class DataGridThemeResourceCoverageTests
{
    ...
    private static readonly ControlThemeExpectation[] GenericControlThemeExpectations =
    {
        ...
        new("DataGridOptimizedCellTheme", typeof(DataGridCell)),
        new("DataGridOptimizedDrawingCellTheme", typeof(DataGridCustomDrawingCell)),
        new("DataGridOptimizedDirectTextCellTheme", typeof(DataGridDirectTextCell)),
        new("DataGridOptimizedDirectHierarchicalCellTheme", typeof(DataGridDirectHierarchicalCell)),
        new("DataGridOptimizedDirectTextHierarchicalCellTheme", typeof(DataGridDirectHierarchicalCell)),
        new("DataGridOptimizedRowTheme", typeof(DataGridRow)),
        new("DataGridOptimizedUnfrozenRowTheme", typeof(DataGridRow)),
        new("DataGridOptimizedColumnHeaderTheme", typeof(DataGridColumnHeader)),
        new("DataGridOptimizedFeatureRowTheme", typeof(DataGridRow)),
        new("DataGridOptimizedFeatureUnfrozenRowTheme", typeof(DataGridRow)),
        new("DataGridOptimizedFeatureColumnHeaderTheme", typeof(DataGridColumnHeader)),
