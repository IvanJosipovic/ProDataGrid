...
public class DataGridDiagnosticsTests
{
    ...
    public void DataGrid_Emits_Activities_And_Metrics()
    {
        ...
        AssertHasDoubleMeasurement(listener, DataGridDiagnostics.Meters.RowsScrollViewportDeltaName);
        ...
        AssertHasLongMeasurement(listener, DataGridDiagnostics.Meters.RowsMeasuredCountName);
        AssertHasLongMeasurement(listener, DataGridDiagnostics.Meters.RowsMeasureSkippedCountName);
        AssertHasLongMeasurement(listener, DataGridDiagnostics.Meters.RowsArrangedCountName);
        AssertHasLongMeasurement(listener, DataGridDiagnostics.Meters.RowsArrangeSkippedCountName);
        AssertHasLongMeasurement(listener, DataGridDiagnostics.Meters.RowsScrollInfoChangedCountName);
        AssertHasLongMeasurement(listener, DataGridDiagnostics.Meters.RowsScrollExtentChangedCountName);
        AssertHasLongMeasurement(listener, DataGridDiagnostics.Meters.RowsScrollViewportChangedCountName);
        AssertHasLongMeasurement(listener, DataGridDiagnostics.Meters.RowsScrollInvalidatedCountName);
