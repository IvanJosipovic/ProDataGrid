...
internal
        ...
        IDataGridDrawnCellValueChangeTracking
    {
        ...
        private readonly DataGridCustomDrawingTextLayoutCache _drawnTextLayoutCache =
        ...
        protected override Control GenerateElement(DataGridCell cell, object dataItem)
        {
            if (cell is DataGridCustomDrawingCell drawingCell)
            {
                ...
                try
                {
                    drawingCell.SharedTextLayoutCache = _drawnTextLayoutCache;
                    drawingCell.SetCurrentValue(
                        DataGridCustomDrawingCell.TextLayoutCacheModeProperty,
