...
internal static partial class DataGridDiagnostics
{
    ...
    private static Counter<long>? s_rowsDisplayScanned;
    private static Counter<long>? s_rowsDisplayRemoved;
    ...
    private static Counter<long>? s_rowsArrangeOffscreen;
    ...
    public static void InitMetrics()
    {
        ...
        s_rowsDisplayScan = meter.CreateHistogram<double>(
        ...
        s_rowsDisplayTrim = meter.CreateHistogram<double>(
            ...
            Meters.MillisecondsUnit,
            Meters.RowsDisplayTrimTimeDescription);
        ...
        s_rowsDisplayScanned = meter.CreateCounter<long>(
            Meters.RowsDisplayScannedCountName,
            Meters.RowsUnit,
            Meters.RowsDisplayScannedCountDescription);
        s_rowsDisplayRemoved = meter.CreateCounter<long>(
            Meters.RowsDisplayRemovedCountName,
            Meters.RowsUnit,
            Meters.RowsDisplayRemovedCountDescription);
        ...
        s_rowsArrangeOffscreen = meter.CreateCounter<long>(
            Meters.RowsArrangeOffscreenCountName,
            Meters.RowsUnit,
            Meters.RowsArrangeOffscreenCountDescription);
    ...
    public static HistogramReportDisposable BeginRowsDisplayScan() => Begin(s_rowsDisplayScan);
    public static HistogramReportDisposable BeginRowsDisplayTrim() => Begin(s_rowsDisplayTrim);
    ...
    public static void RecordRowsDisplayScanned(int count)
    {
        if (count > 0)
        {
            s_rowsDisplayScanned?.Add(count);
        }
    }

    public static void RecordRowsDisplayRemoved(int count)
    {
        if (count > 0)
        {
            s_rowsDisplayRemoved?.Add(count);
        }
    }

    public static void RecordRowsMeasured(int count)
    {
        if (count > 0)
        {
            s_rowsMeasured?.Add(count);
        }
    }

    public static void RecordRowsMeasureSkipped(int count)
    {
        if (count > 0)
        {
            s_rowsMeasureSkipped?.Add(count);
        }
    }

    public static void RecordRowsArranged(int count)
    {
        if (count > 0)
        {
            s_rowsArranged?.Add(count);
        }
    }

    public static void RecordRowsArrangeSkipped(int count)
    {
        if (count > 0)
        {
            s_rowsArrangeSkipped?.Add(count);
        }
    }

    public static void RecordRowsArrangeOffscreen(int count)
    {
        if (count > 0)
        {
            s_rowsArrangeOffscreen?.Add(count);
        }
    }
