...
internal
#endif
    class DataGridImageColumn : DataGridBoundColumn, IDataGridDrawnCellValueProvider
    {
        ...
        protected override Control GenerateElement(DataGridCell cell, object dataItem)
        {
            if (cell is DataGridCustomDrawingCell drawingCell)
            {
                ...
                {
                    drawingCell.ConfigureBuiltInRenderer(this, DataGridImageCellRenderer.Instance);
                }
                else
                {
                    drawingCell.ConfigureBuiltInRenderer(valueProvider: null, renderer: DataGridImageCellRenderer.Instance);
