...
internal
#endif
    class DataGridProgressBarColumn : DataGridBoundColumn, IDataGridDrawnCellValueProvider
    {
        ...
        protected override void OnPropertyChanged(AvaloniaPropertyChangedEventArgs change)
        {
                ...
                || change.Property == HeightProperty)
            {
                ...
                if (change.Property == ShowProgressTextProperty && DisplayMode == DataGridColumnDisplayMode.Drawn)
                {
        ...
        protected override Control GenerateElement(DataGridCell cell, object dataItem)
        {
            if (cell is DataGridCustomDrawingCell drawingCell)
            {
                ...
                {
                    drawingCell.ConfigureBuiltInRenderer(this, DataGridProgressCellRenderer.Instance);
                }
                else
                {
                    drawingCell.ConfigureBuiltInRenderer(valueProvider: null, renderer: DataGridProgressCellRenderer.Instance);
        ...
        internal override bool SupportsDrawnDisplay => !ShowProgressText;
