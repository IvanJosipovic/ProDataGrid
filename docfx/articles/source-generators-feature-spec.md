...
Current status: implemented. The generated-only NativeAOT application additionally verifies schema, controller, registry, Avalonia view, ReactiveUI view, custom-base, trimming-analysis, native-link, and native-execution compatibility in CI.
